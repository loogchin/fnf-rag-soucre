...
class PlayState extends MusicBeatState
{
	...
	var funsky:FlxSprite;
	var funbush:FlxSprite;
	var funbush2:FlxSprite;
	var funfloor:FlxSprite;
		...
		switch (curStage)
		{
			case 'stage': //Week 1
				...
				if(songName == 'rag')
				{
					...
					//sonicfun
					funsky = new FlxSprite(-600, -200).loadGraphic(Paths.image('FunInfiniteStage/sonicFUNsky'));
					...
					funbush = new FlxSprite(-42, 171).loadGraphic(Paths.image('FunInfiniteStage/Bush2'));
					...
					funpillarts2ANIM.frames = Paths.getSparrowAtlas('FunInfiniteStage/Majin Boppers Back');
					...
					funbush2 = new FlxSprite(132, 354).loadGraphic(Paths.image('FunInfiniteStage/Bush 1'));
					...
					funpillarts1ANIM.frames = Paths.getSparrowAtlas('FunInfiniteStage/Majin Boppers Front');
					...
					funfloor = new FlxSprite(-340, 660).loadGraphic(Paths.image('FunInfiniteStage/floor BG'));
					...
					funboppers1ANIM.frames = Paths.getSparrowAtlas('FunInfiniteStage/majin FG1');
					...
					funboppers2ANIM.frames = Paths.getSparrowAtlas('FunInfiniteStage/majin FG2');
					...
					funbush2.alpha = 0;
					funfloor.alpha = 0;
					funpillarts1ANIM.alpha = 0;
					funpillarts2ANIM.alpha = 0;
					funboppers1ANIM.alpha = 0;
					funboppers2ANIM.alpha = 0;

					cg = new FlxSprite(-600, -200).loadGraphic(Paths.image('cg5/mixroom'));
					cg.antialiasing = true;
					cg.scrollFactor.set(0.9, 0.9);
					cg.active = false;
					add(cg);

					cg1 = new FlxSprite(-600, -200).loadGraphic(Paths.image('cg5/recordroom'));
					//cg1.setGraphicSize(Std.int(cg1.width * 1.1));
					//cg1.updateHitbox();
					cg1.antialiasing = true;
					cg1.scrollFactor.set(0.9, 0.9);
					cg1.active = false;
					//add(cg1);
					...
					ron1 = new FlxSprite(-100,10).loadGraphic(Paths.image('ron/happyRon_sky'));
					ron1.updateHitbox();
					ron1.scale.x = 1.2;
					ron1.scale.y = 1.2;
					ron1.active = false;
					ron1.antialiasing = true;
					ron1.scrollFactor.set(0.1, 0.1);
					add(ron1);

					ground = new FlxSprite(-537, -250).loadGraphic(Paths.image('ron/happyRon_ground'));
					ground.updateHitbox();
					ground.active = false;
					...
					sayori = new FlxSprite(-200, -100);
					sayori.frames = Paths.getSparrowAtlas('sayori/halloween_bg');
					sayori.animation.addByPrefix('idle', 'halloweem bg0');
					sayori.animation.addByPrefix('lightning', 'halloweem bg lightning strike', 24, false);
					...
					dad = new Character(0, 0, 'majin sonic');
					startCharacterPos(dad, true);
					dadGroup.add(dad);
					dadGroup.remove(dad);

					boyfriend = new Boyfriend(0, 0, 'bf-pixel');
					startCharacterPos(boyfriend);
					boyfriendGroup.add(boyfriend);
					boyfriendGroup.remove(boyfriend);

					boyfriend = new Boyfriend(0, 0, 'bf-pixel-dead');
					startCharacterPos(boyfriend);
					boyfriendGroup.add(boyfriend);
					boyfriendGroup.remove(boyfriend);

					boyfriend = new Boyfriend(0, 0, 'bf fun');
					startCharacterPos(boyfriend);
					boyfriendGroup.add(boyfriend);
					boyfriendGroup.remove(boyfriend);
					...
					boyfriend = new Boyfriend(0, 0, 'bfs');
					startCharacterPos(boyfriend);
					boyfriendGroup.add(boyfriend);
					boyfriendGroup.remove(boyfriend);

					dad = new Character(0, 0, 'sayori');
					startCharacterPos(dad, true);
					dadGroup.add(dad);
					dadGroup.remove(dad);
					...
					dad = new Character(0, 0, 'ron');
					startCharacterPos(dad, true);
					dadGroup.add(dad);
					dadGroup.remove(dad);

					gf = new Character(0, 0, 'gf cg5');
					startCharacterPos(gf);
					gf.scrollFactor.set(0.95, 0.95);
					gfGroup.add(gf);
					gfGroup.remove(gf);
	...
	private function generateSong(dataPath:String):Void
	{
		...
		{
			if(Paths.formatToSongPath(SONG.song) == 'rag')
				switch (daSection)
					{
						case 17:
							SONG.arrowSkin = 'PIXELNOTE_assets';
						case 22:
			...
			for (songNotes in section.sectionNotes)
			{
				if(songNotes[1] > -1) { //Real notes
					...
					var swagNote:Note = new Note(daStrumTime, daNoteData, oldNote, SONG.arrowSkin);
					...
					if(floorSus > 0) {
						for (susNote in 0...floorSus+1)
						{
							...
							var sustainNote:Note = new Note(daStrumTime + (Conductor.stepCrochet * susNote) + (Conductor.stepCrochet / FlxMath.roundDecimal(SONG.speed, 2)), daNoteData, oldNote, true, SONG.arrowSkin);
		...
		if(Paths.formatToSongPath(SONG.song) == 'rag')
			{
				switch(curStep)
				{
					...
					case 283:
						...
						SONG.arrowSkin = 'NOTE_assets';
						changecharacter('0', 'bf-pixel');
						changecharacter('1', 'senpai');
						changecharacter('2', 'gf-pixel');
					...
					case 360:
						...
						generateStaticArrows(1, false);
						SONG.arrowSkin = 'NOTE_assets';
						changecharacter('0', 'bf');
						changecharacter('1', 'dad');
						...
						bgGirls.alpha = 0;
					case 441:
						changecharacter('0', 'bf fun');
						changecharacter('1', 'majin sonic');
						boyfriend.setPosition(770, 450);
						dad.setPosition(100, 100);
						gf.setPosition(400, 130);
						gf.alpha = 0;
						...
						funbush2.alpha = 1;
						funfloor.alpha = 1;
						funpillarts1ANIM.alpha = 1;
						funpillarts2ANIM.alpha = 1;
						funboppers1ANIM.alpha = 1;
						funboppers2ANIM.alpha = 1;
					case 480:
						changecharacter('0', 'bf');
						changecharacter('1', 'cg');
						changecharacter('2', 'gf cg5');
						boyfriend.setPosition(770, 450);
						dad.setPosition(100, 100);
						gf.setPosition(400, 130);
						...
						funboppers2ANIM.alpha = 0;
					case 721:
						changecharacter('0', 'bfs');
						changecharacter('1', 'sayori');
						changecharacter('2', 'gf');
						boyfriend.setPosition(770, 450);
						dad.setPosition(100, 100);
						gf.setPosition(400, 130);
	...
	function changecharacter(type:String ,char:String) // 0 = bf / 1 = dad / 2 = gf
		{
			var charType:Int = Std.parseInt(type);
				if(Math.isNaN(charType)) charType = 0;
